...
| C++ dense/GDN/attention-batched verifier | 62.11 ms for three rows versus 94.55 ms serial; 1.522x; exact token and rollback-continuation parity | Layer-major scheduling plus batched HC, GDN, and full-attention projections improve verifier cost | Depth 2, empty origin, one interleaved A/B/B/A run; still above the retained P73 round cost |
