...
void run_runtime_tests() {
    const auto automatic = qwen38::automatic_runtime_config();
    QWEN38_CHECK(automatic.allocator_cache_mib == 256);
    QWEN38_CHECK(automatic.resident_expert_range == "12:29");
    ...
    QWEN38_CHECK(qwen38::select_prefill_chunk_rows(2048, 8192) == 2048);
    QWEN38_CHECK(qwen38::select_prefill_chunk_rows(2048, 32769) == 512);
