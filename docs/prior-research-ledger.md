...
| C++ dense/GDN-batched layer-major verifier | 62.97 ms for three rows versus 94.06 ms serial; 1.494x; exact token and rollback-continuation parity | Layer-major scheduling plus batched HC and GDN projections improve verifier cost | Depth 2, empty origin, one interleaved A/B/B/A run; still above the retained P73 round cost |
